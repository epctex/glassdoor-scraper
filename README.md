...
-   Get extensive company information - Get all information of a company right away!

-   Looking for jobs? You are at the right place! - Retrieve all the job information of a company with supported by filters. Extremely fast data retrieval!

-   All detailed salary information are at your fingertips! - Salary information and all the detailed pricing is at your service!
...
- `startUrls`: (Optional) (Array) List of Glassdoor URLs. It should be company, salary, interview, job, search or any listing URL.
...
The actor optimized to run blazing fast and scrape as many items as possible. Therefore, it forefronts all the detail requests. If actor doesn't block very often it'll scrape 100 listings in 2 minutes with ~0.25-0.45 compute units.
...
You can manage the results in any languague (Python, PHP, Node JS/NPM). See the FAQ or <a href="https://www.apify.com/docs/api" target="blank">our API reference</a> to learn more about getting results from this Glassdoor actor.
